      ...
      <>
        <Row>
            {this.state.submitted &&
             <span>Data sukses ditambahkan</span>
            }
          <Col xs={12} xl={8}>
          <Card border="light" className="bg-white shadow-sm mb-4">
          <Card.Body style={{backgroundColor:"#e0edf3"}}>
          <h5 className="mb-4">Tambahkan dokumen yang ingin diarsipkan</h5>
          <Form>
            <Row>
            ...
            <Row className="align-items-center">
              ...
              <Col md={6} className="mb-3">
                <Form.Group id="documentType">
                  ...
                  <Form.Select defaultValue="surat-masuk"
                          name="documentType" 
                          onChange={this.onChange}>
            ...
            <div className="mt-3">
              <Button variant="primary" type="submit" data-bs-toggle="modal" data-bs-target="#modalNotification"
												onClick={e => this.saveArchive(e)}>Simpan Data</Button>
              {this.state.submitted && (
                          <img
                            alt="loading"
