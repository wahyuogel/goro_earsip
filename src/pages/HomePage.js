...
export default () => (
  <Switch>
    ...
    <RouteWithSidebar exact path={Routes.Search.path} component={SearchDocument} />
    ...
    <RouteWithSidebar exact path={Routes.SuratMasuk.path} component={SuratMasuk} />
    <RouteWithSidebar exact path={Routes.SuratKeluar.path} component={SuratKeluar} />
    <RouteWithSidebar exact path={Routes.PaketKonsultasi.path} component={PaketKonsultasi} />
    ...
    <RouteWithSidebar exact path={Routes.JustifikasiTeknis.path} component={JustifikasiTeknis} />
    <RouteWithSidebar exact path={Routes.Rpb.path} component={Rpb} />
    <RouteWithSidebar exact path={Routes.PadatKarya.path} component={PadatKarya} />
    <RouteWithSidebar exact path={Routes.UndangUndang.path} component={UndangUndang} />
    <RouteWithSidebar exact path={Routes.PeraturanMenteri.path} component={PeraturanMenteri} />
    <RouteWithSidebar exact path={Routes.SuratEdaran.path} component={SuratEdaran} />
    <RouteWithSidebar exact path={Routes.Keputusan.path} component={Keputusan} />
    <RouteWithSidebar exact path={Routes.SpesifikasiUmumKhusus.path} component={SpesifikasiUmumKhusus} />
    <RouteWithSidebar exact path={Routes.ManualPelaksanaan.path} component={ManualPelaksanaan} />
