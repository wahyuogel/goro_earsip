...
class LaporanEmonitoring extends Component {
	constructor(props) {
		super(props);
		const pathName = "laporan-emonitoring";
		const documentType = pathName.replace("/", "");
		const documentTypeLabel = "Laporan E-Monitoring";
...
export default LaporanEmonitoring;
