...
class JustifikasiTeknis extends Component {
  constructor(props) {
    super(props);
    const pathName = "justifikasi-teknis"
      ...
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
          <div className="d-block mb-4 mb-md-0">
            <Breadcrumb className="d-none d-md-inline-block" listProps={{ className: "breadcrumb-dark breadcrumb-transparent" }}>
              ...
              <Breadcrumb.Item active>{this.state.documentTypeLabel.toLowerCase()}</Breadcrumb.Item>
            </Breadcrumb>
            <h4>{this.state.documentTypeLabel.toUpperCase()}</h4>
            <p className="mb-0">Manajemen data dari {this.state.documentTypeLabel.toLowerCase()}</p>
          </div>
        </div>
...
export default JustifikasiTeknis;
