    ...
    return (
      <>
        ...
        <Card.Body style={{backgroundColor:"#ffffdf"}}>
          <h5 className="mb-4">Ubah dokumen yang telah diarsipkan - {this.state.documentNameLabel} </h5>
          <Form>
            <Row>
            ...
            <Row className="align-items-center">
                    ...
                    renderInput={(props, openCalendar) => (
                      <InputGroup>
                        ...
                        <Form.Control
                          ...
                          type="text"
                          name="documentDate"
                          value={this.state.documentDate ? moment(this.state.documentDate).format("MM/DD/YYYY") : ""}
              ...
              <Col md={6} className="mb-3">
                <Form.Group id="documentType">
                  ...
                  <Form.Select value={this.state.documentType}
                          name="documentType" 
                          onChange={this.onChange}>
                    <option value="surat-masuk">Surat Masuk</option>
                    <option value="surat-keluar">Surat Keluar</option>
                    <option value="paket-konsultasi">Paket Konsultasi</option>
                    ...
                    <option value="spesifikasi-umum-khusus">Spesifikasi Umum &amp; Khusus</option>
                    <option value="manual-pelaksanaan">Manual Pelaksanaan</option>
            ...
            <Row>
              ...
              Dokumen yang telah diupload :  <a href={this.state.linkUpload} style={{textDecoration:"underline"}}>{this.state.documentNameLabel}</a>
              <br/>
              <br />
              <span className="text-small"><i>*Klik link diatas untuk lihat file. Lewati bagian ini jika tidak ada perubahan dokumen yang telah diupload</i></span>
              <FileUploader className="text" handlerUpload={
                value => this.handlerFileUploader("linkUpload",value)} />
              </Col>
            </Row>
            <div className="mt-3">
              <Button variant="primary" type="submit" data-bs-toggle="modal" data-bs-target="#modalNotification"
												onClick={e => this.updateArchive(this.state.key, e)}>Ubah Data</Button>
